...
void changeState(uint8_t newState) {
  ...
  switch(newState) {
    case STATE_WIFI_CONNECT: {
      Phase tasks[] = {Phase(50, LOW), Phase(50, HIGH), Phase(250, LOW), Phase(50, HIGH), Phase(250, LOW)};
    ...
    case STATE_MAIN_WORK: {
      ...
      Phase tasks[] = { Phase(50, LOW), Phase(50, HIGH), Phase(50, LOW), Phase(50, HIGH), Phase(800, LOW),};
      led = new LedBlink(PIN_LED_BUILTIN, tasks, 5, true);
      led->start();
